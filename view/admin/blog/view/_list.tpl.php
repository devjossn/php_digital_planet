...
<div class="row gutters align middle">
  ...
  <div class="columns auto mobile-100 phone-100">
    <a href="<?php echo Url::url(Router::$path, "new/");?>" class="wojo small secondary stacked button"><i class="icon plus alt"></i><?php echo Lang::$word->_MOD_AM_NEW;?></a>
    <a data-dropdown="#dropdown-blogMenu" class="wojo small white icon button">
...
<div class="center aligned">
  <div class="wojo small divided horizontal list">
    ...
    <?php echo Lang::$word->_MOD_AM_HITS;?>
    </a>
...
<div class="wojo card" id="item_<?php echo $row->id;?>">
  <div class="header">
    <div class="row horizontal gutters align top">
      <div class="columns auto center aligned phone-100"><img src="<?php echo Blog::hasThumb($row->thumb, $row->id);?>" alt="" class="wojo normal inline image"></div>
      <div class="columns phone-100">
        <p class="wojo small text">
          <a class="grey" href="<?php echo Url::url("/admin/blog/category",  $row->category_id);?>"><?php echo $row->name;?></a>
        </p>
        <h4>
  ...
  <div class="footer divided">
    <div class="row align middle">
      ...
      <div class="columns auto phone-100">
        <a class="wojo small positive icon button" href="<?php echo Url::url("/admin/blog/edit", $row->id);?>"><i class="icon pencil"></i></a>
        <a data-set='{"option":[{"delete": "deleteItem","title": "<?php echo Validator::sanitize($row->title, "chars");?>","id":<?php echo $row->id;?>}],"action":"delete","parent":"#item_<?php echo $row->id;?>","url":"blog/controller.php"}' class="wojo small negative icon button data">
