...
?>
<h2><?php echo Lang::$word->_MOD_AM_NEWCAT;?></h2>
<form method="post" id="wojo_form" name="wojo_form">
  <div class="wojo form segment">
    <div class="wojo fields">
      ...
      <div class="field five wide">
        ...
        <input type="text" placeholder="<?php echo Lang::$word->_MOD_AM_CSLUG;?>" name="slug">
      </div>
    </div>
    <div class="wojo fields">
      <div class="field">
  ...
  <div class="center aligned">
    ...
    <button type="button" data-url="blog" data-action="processCategory" name="dosubmit" class="wojo secondary button"><?php echo Lang::$word->_MOD_AM_NEWCAT;?></button>
  </div>
</form>
