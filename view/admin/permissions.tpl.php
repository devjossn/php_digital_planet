...
<!-- Start privileges -->
<h2><?php echo Lang::$word->META_M_PRIVILEGE;?></h2>
<p><?php echo str_replace("[ROLE]", '<span class="wojo bold text">' . $this->role->name . '</span>', Lang::$word->PS_INFO1);?>
  <?php echo ($this->role->code != "owner") ? '<span class="wojo bold text"><br><i>' . Lang::$word->PS_INFO2 . '</i></span>' : null;?></p>
...
<?php break;?>
<?php default: ?>
<h2><?php echo Lang::$word->META_M_PERMISSIONS;?></h2>
<p class="wojo small text"><?php echo Lang::$word->PS_INFO;?></p>
<div class="wojo cards screen-3 tablet-3 mobile-1">
  ...
  <div class="card">
    ...
    <div class="footer divided center aligned">
      ...
      <a data-set='{"option":[{"action":"editRole","id": <?php echo $row->id;?>}], "label":"<?php echo Lang::$word->PS_LABEL;?>", "url":"helper.php", "parent":"#item_<?php echo $row->id;?>", "complete":"replace", "modalclass":"normal"}' class="wojo icon primary circular inverted button action">
