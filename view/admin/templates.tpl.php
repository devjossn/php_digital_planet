...
<h2><?php echo Lang::$word->ET_EDIT;?></h2>
    ...
    <div class="wojo fields">
      <div class="field">
        ...
        <div class="wojo small input">
          <textarea class="small" placeholder="<?php echo Lang::$word->DESCRIPTION;?>" name="help"><?php echo $this->data->help;?></textarea>
        </div>
      </div>
    </div>
    <div class="center aligned">
      <a href="<?php echo Url::url("/admin/templates");?>" class="wojo simple small button"><?php echo Lang::$word->CANCEL;?></a>
...
<?php break;?>
<?php default: ?>
<h2><?php echo Lang::$word->META_M_TEMPLATES;?></h2>
<p class="wojo small text"><?php echo Lang::$word->ET_INFO;?></p>
