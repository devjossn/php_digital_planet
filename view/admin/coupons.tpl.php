<?php
   ...
   * @copyright 2020
   * @version $Id: coupons.tpl.php, v1.00 2020-02-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<!-- Start edit -->
<h2><?php echo Lang::$word->DC_EDIT;?></h2>
<form method="post" id="wojo_form" name="wojo_form">
  <div class="wojo segment form">
    ...
    <div class="wojo fields">
      <div class="field five wide">
        <label><?php echo Lang::$word->DC_VALID;?>
          <i class="icon asterisk"></i></label>
        <div class="wojo icon input">
          <input name="validuntil" type="text" placeholder="<?php echo Lang::$word->TO;?>" value="<?php echo Date::doDate("MM/dd/yyyy", $this->data->validuntil);?>" readonly class="datepick">
          <i class="icon date"></i>
        </div>
      </div>
      <div class="field five wide">
    ...
    <div class="wojo fields">
      <div class="field five wide">
        <label><?php echo Lang::$word->DC_MIN;?>
          <i class="icon asterisk"></i></label>
        <div class="wojo labeled input">
          <div class="wojo simple label"><?php echo Utility::currencySymbol(App::Core()->currency);?></div>
          <input type="text" placeholder="<?php echo Lang::$word->DC_MIN;?>" value="<?php echo $this->data->minval;?>" name="minval">
...
<?php case "new": ?>
<!-- Start new -->
<h2><?php echo Lang::$word->DC_NEW;?></h2>
<form method="post" id="wojo_form" name="wojo_form">
  <div class="wojo segment form">
    <div class="wojo fields">
      <div class="field five wide">
    ...
    <div class="wojo fields">
      <div class="field five wide">
        <label><?php echo Lang::$word->DC_VALID;?>
          <i class="icon asterisk"></i></label>
        <div class="wojo icon input">
          <input placeholder="<?php echo Lang::$word->TO;?>" name="validuntil" type="text" value="<?php echo Date::doDate("MM/dd/yyyy", Date::NumberOfDays('+1 month'));?>" readonly class="datepick">
          <i class="icon date"></i>
        </div>
      </div>
      <div class="field five wide">
    ...
    <div class="center aligned">
      ...
      <button type="button" data-action="processCoupon" name="dosubmit" class="wojo secondary button"><?php echo Lang::$word->DC_CREATE;?></button>
    </div>
  </div>
</form>
<?php break;?>
...
<div class="row gutters align middle">
  <div class="columns mobile-100 phone-100">
    <h2><?php echo Lang::$word->META_M_COUPONS;?></h2>
    <p class="wojo small text"><?php echo Lang::$word->DC_INFO;?></p>
  </div>
  <div class="column auto mobile-100 phone-100">
    <a href="<?php echo Url::url(Router::$path, "new/");?>" class="wojo small secondary button stacked"><i class="icon plus alt"></i><?php echo Lang::$word->DC_NEW;?></a>
  </div>
</div>
<?php if(!$this->data):?>
<div class="center aligned"><img src="<?php echo ADMINVIEW;?>/images/notfound.png" alt="">
  <p class="wojo small thick caps text"><?php echo Lang::$word->DC_EMPTY;?></p>
</div>
<?php else:?>
