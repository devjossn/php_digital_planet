...
?>
<h2><?php echo Lang::$word->META_M_MAINTENANCE;?></h2>
  ...
  <div class="wojo form segment">
    <div class="wojo fields">
      <div class="field three wide basic">
        ...
        <p><?php echo str_replace("[TOTAL]", '<span class="wojo primary inverted label" id="banned">' . $this->banned . '</span>', Lang::$word->MT_BUSERS_T);?></p>
      </div>
...
<form method="post" name="wojo_forms">
  <div class="wojo form segment">
    <div class="wojo fields">
      <div class="field three wide basic">
        <label><?php echo Lang::$word->MT_MAP;?></label>
        <p class="wojo small text"><?php echo Lang::$word->MT_MAP_;?></p>
      </div>
      <div class="field five wide basic">
        <label><?php echo Lang::$word->MT_GENERATE;?></label>
        <button type="button" data-action="processMap" name="dosubmit" class="wojo small primary button"><?php echo Lang::$word->MT_GENERATE;?></button>
      </div>
    </div>
  </div>
</form>