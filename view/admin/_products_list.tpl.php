<?php
   ...
   * @copyright 2020
   * @version $Id: _products_list.tpl.php, v1.00 2020-01-08 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<div class="row gutters align middle">
  ...
  <div class="columns right aligned mobile-50 phone-100 mobile-order-2">
    <a href="<?php echo Url::url(Router::$path, "new/");?>" class="wojo small secondary stacked button"><i class="icon plus alt"></i><?php echo Lang::$word->PRD_NEW;?></a>
  </div>
...
<div class="wojo card" id="item_<?php echo $row->id;?>">
  <div class="header">
    <div class="row horizontal gutters align top">
      <div class="columns auto"><img src="<?php echo Product::hasThumb($row->thumb, $row->id);?>" alt="" class="wojo normal image"></div>
      <div class="columns">
