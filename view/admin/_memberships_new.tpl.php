<?php
   ...
   * @copyright 2020
   * @version $Id: _memberships_new.tpl.php, v1.00 2020-04-08 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
      die('Direct access to this location is not allowed.');
?>
<h2><?php echo Lang::$word->MEM_NEW;?></h2>
<form method="post" id="wojo_form" name="wojo_form">
  <div class="wojo segment form">
    ...
    <div class="center aligned">
      ...
      <button type="button" data-action="processMembership" name="dosubmit" class="wojo secondary button"><?php echo Lang::$word->MEM_CREATE;?></button>
    </div>
  </div>
</form>