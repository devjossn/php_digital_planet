<?php
   ...
   * @copyright 2020
   * @version $Id: backup.tpl.php, v1.00 2020-05-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<div class="row gutters align middle">
  <div class="columns mobile-100 phone-100">
    <h2><?php echo Lang::$word->META_M_BACKUP;?></h2>
    <p class="wojo small text"><?php echo Lang::$word->DBM_INFO;?></p>
  </div>
  <div class="columns auto mobile-100 phone-100">
    <a data-set='{"option":[{"iaction":"databaseBackup", "id":1}], "url":"/helper.php", "complete":"prepend", "parent":"#backupList"}' class="wojo small secondary button iaction"><i class="icon plus alt"></i><?php echo Lang::$word->DBM_NEW;?></a>
  </div>
</div>
  ...
  <div class="wojo relaxed divided fluid list" id="backupList">
    ...
    <div class="item<?php echo $latest;?>">
      ...
      <div class="content auto"><span class="wojo small dark inverted label"><?php echo File::getFileSize($this->dbdir . '/' . $row, "kb", true);?></span>
        ...
        <a data-set='{"option":[{"delete": "deleteBackup","title": "<?php echo $row;?>","id":1}],"action":"delete","parent":".item"}' class="wojo icon negative inverted circular button data"><i class="icon trash"></i></a>
      </div>
    </div>
    <?php endforeach;?>
    <?php unset($row);?>
