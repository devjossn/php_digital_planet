...
<!-- Start edit -->
<h2><?php echo Lang::$word->MU_EDIT;?></h2>
    ...
    <div class="columns screen-70 tablet-50 mobile-100 phone-100">
      <div class="wojo segment form">
        <div class="wojo block fields">
          ...
          <div class="field">
            <label><?php echo Lang::$word->MU_TYPE;?>
              <i class="icon asterisk"></i></label>
            <select name="content_type" id="contenttype">
              <option value=""><?php echo Lang::$word->MU_TYPE;?></option>
          ...
          <div class="field" id="contentid" style="display:<?php echo ($this->data->content_type != "web") ? 'block' : 'none';?>">
            <label><?php echo Lang::$word->MU_PAGE;?></label>
          ...
          <div id="webid" style="display:<?php echo ($this->data->content_type == "web") ? 'block' : 'none';?>">
            <div class="field">
              <label><?php echo Lang::$word->MU_EXT_URL;?></label>
              <input type="text" name="web" placeholder="<?php echo Lang::$word->MU_EXT_URL;?>" value="<?php echo $this->data->link;?>">
            </div>
            <div class="field">
              <label><?php echo Lang::$word->MU_TARGET_L;?></label>
              <select name="target">
                <option value=""><?php echo Lang::$word->MU_TARGET;?></option>
                <option value="_blank" <?php Validator::getSelected($this->data->target, "_blank");?>><?php echo Lang::$word->MU_TARGET_B;?></option>
                <option value="_self" <?php Validator::getSelected($this->data->target, "_self");?>><?php echo Lang::$word->MU_TARGET_S;?></option>
              </select>
            </div>
          </div>
        </div>
        ...
        <div class="right aligned"><a href="<?php echo Url::url("/admin/menus");?>" class="wojo small simple button"><?php echo Lang::$word->CANCEL;?></a>
          <button type="button" data-action="processMenu" name="dosubmit" class="wojo secondary button"><?php echo Lang::$word->MU_UPDATE;?></button>
        </div>
      </div>
    </div>
    <div class="columns screen-30 tablet-50 mobile-100 phone-100">
      <h3><?php echo Lang::$word->MU_AVAIL;?></h3>
      <p class="wojo small text"><?php echo Lang::$word->MU_INFO1;?></p>
...
<?php break;?>
<?php default: ?>
<h2><?php echo Lang::$word->META_M_MENUS;?></h2>
<p class="wojo small text"><?php echo Lang::$word->MU_INFO;?></p>
<form method="post" id="wojo_form" name="wojo_form">
  <div class="row gutters">
    <div class="columns screen-70 tablet-50 mobile-100 phone-100">
      <div class="wojo segment form">
        <div class="wojo block fields">
          ...
          <div id="webid" class="hide-all">
            <div class="field">
              <label><?php echo Lang::$word->MU_EXT_URL;?></label>
              <input type="text" name="web" placeholder="<?php echo Lang::$word->MU_EXT_URL;?>">
            </div>
            <div class="field">
              <label><?php echo Lang::$word->MU_TARGET_L;?></label>
              <select name="target">
                <option value=""><?php echo Lang::$word->MU_TARGET;?></option>
                <option value="_blank"><?php echo Lang::$word->MU_TARGET_B;?></option>
                <option value="_self"><?php echo Lang::$word->MU_TARGET_S;?></option>
              </select>
            </div>
          </div>
        </div>
        ...
        <div class="right aligned">
          <button type="button" data-action="processMenu" name="dosubmit" class="wojo secondary button"><?php echo Lang::$word->MU_CREATE;?></button>
        </div>
      </div>
    </div>
    <div class="columns screen-30 tablet-50 mobile-100 phone-100">
      <h2><?php echo Lang::$word->MU_AVAIL;?></h2>
      <p class="wojo small text"><?php echo Lang::$word->MU_INFO1;?></p>
      <div id="sortlist" class="dd">
        <?php if($this->sortlist) : echo $this->sortlist; endif;?>
      </div>
