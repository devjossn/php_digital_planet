<?php
   ...
   * @copyright 2020
   * @version $Id: system.tpl.php, v1.00 2020-05-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
?>
<h3><?php echo Lang::$word->META_M_SYSTEM;?></h3>
      ...
      <table class="wojo two basic column table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo File::_fixPath(BASEPATH);?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><?php echo File::_fixPath(UPLOADS);?></td>
          </tr>
          <tr>
            <td><?php echo Lang::$word->SYS_ADMVIEW;?>:</td>
            <td><?php echo File::_fixPath(ADMINBASE);?></td>
          </tr>
          <tr>
