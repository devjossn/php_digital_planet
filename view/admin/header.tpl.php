...
<body data-theme="<?php echo Session::cookieExists("DDPA_THEME", "dark") ? "dark" : "light";?>">
<header>
  <div class="wojo-grid">
    <div class="row horizontal small gutters align middle">
      ...
      <div class="columns auto">
        ...
        <div class="wojo small dropdown top-right" id="dropdown-uMenu">
          ...
          <?php echo Lang::$word->ADM_CHPASS;?></a>
          <a class="atheme-switch item" data-mode="<?php echo Session::cookieExists("DDPA_THEME", "dark") ? "dark" : "light";?>"><i class="icon contrast"></i><span><?php echo Session::cookieExists("DDPA_THEME", "dark") ? "Light" : "Dark";?></span></a>
...
<div class="navbar">
  <div class="wojo-grid">
    <nav class="wojo menu">
      <ul>
        <li<?php if (Utility::in_array_any(["menus","categories","templates","countries","coupons","fields","news","mailer","pages", "faq", "comments", "memberships", "blog"], $this->segments)) echo ' class="active"';?>>
         <a href="#">
        <img src="<?php echo ADMINVIEW;?>/images/content.svg">
        <span><?php echo Lang::$word->ADM_CONTENT;?></span><i class="icon chevron down"></i></a>
          <ul>
            <li><a<?php if (in_array("menus", $this->segments)) echo ' class="active"';?> href="<?php echo Url::url("/admin/menus");?>"><?php echo Lang::$word->ADM_MENUS;?></a>
            </li>
            <li><a<?php if (in_array("categories", $this->segments)) echo ' class="active"';?> href="<?php echo Url::url("/admin/categories");?>"><?php echo Lang::$word->ADM_CATS;?></a>
            </li>
            ...
            <li><a<?php if (in_array("comments", $this->segments)) echo ' class="active"';?> href="<?php echo Url::url("/admin/comments");?>"><?php echo Lang::$word->ADM_CMNTS;?></a>
            </li>
            ...
            <li><a<?php if (in_array("blog", $this->segments)) echo ' class="active"';?> href="<?php echo Url::url("/admin/blog");?>"><?php echo Lang::$word->ADM_BLOG;?></a>
            </li>
            <li><a<?php if (in_array("faq", $this->segments)) echo ' class="active"';?> href="<?php echo Url::url("/admin/faq");?>"><?php echo Lang::$word->ADM_FAQ;?></a>
            </li>
            ...
            <li><a<?php if (in_array("memberships", $this->segments)) echo ' class="active"';?> href="<?php echo Url::url("/admin/memberships");?>"><?php echo Lang::$word->ADM_MEMS;?></a>
            </li>
          </ul>
        </li>
        ...
        <li<?php if (in_array("products", $this->segments)) echo ' class="active"';?>>
          <a href="<?php echo Url::Url("/admin/products");?>">
          <img src="<?php echo ADMINVIEW;?>/images/products.svg">
          <span class="title"><?php echo Lang::$word->ADM_PROD;?></span>
          </a>
        </li>
