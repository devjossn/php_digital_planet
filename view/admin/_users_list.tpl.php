...
<div class="row gutters align middle">
  ...
  <div class="columns right aligned mobile-50 phone-100 mobile-order-2">
    <a href="<?php echo Url::url(Router::$path, "new/");?>" class="wojo small secondary stacked button"><i class="icon plus alt"></i><?php echo Lang::$word->USR_NEW;?></a>
  </div>
    ...
    <div class="row align middle">
      <div class="columns">
        <div class="wojo horizontal small list">
          <div class="item">
            <div class="header"><?php echo Lang::$word->EMAIL;?>
          ...
          <div class="item">
            <div class="header"><?php echo Lang::$word->PURCHASES;?>
              <span class="description"><?php echo ($row->items > 0) ? $row->items : '-/-';?></span>
            </div>
          </div>
        </div>
      </div>
