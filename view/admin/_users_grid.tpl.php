...
<div class="row gutters align middle">
  <div class="columns auto mobile-100 mobile-order-1">
    <h2><?php echo Lang::$word->META_M_USERS;?></h2>
  </div>
  <div class="columns right aligned mobile-50 phone-100 mobile-order-2">
    <a href="<?php echo Url::url("/admin/users", "new/");?>" class="wojo small secondary stacked button"><i class="icon plus alt"></i><?php echo Lang::$word->USR_NEW;?></a>
  </div>
...
<div class="center aligned"><img src="<?php echo ADMINVIEW;?>/images/notfound.png" alt="">
  <p class="wojo small thick caps text"><?php echo Lang::$word->USR_EMPTY;?></p>
</div>
<?php else:?>
    ...
    <div class="wojo attached card">
      ...
      <div class="footer divided">
        <p class="wojo small text">
          <?php echo Lang::$word->EMAIL;?>: <a href="<?php echo Url::url("/admin/mailer", "?email=" . urlencode($row->email));?>"><?php echo $row->email;?></a>
        </p>
        <p class="wojo small text"><?php echo Lang::$word->PURCHASES;?>: <?php echo ($row->items > 0) ? $row->items : '-/-';?></p>
