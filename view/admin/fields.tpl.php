<?php
   ...
   * @copyright 2020
   * @version $Id: fields.tpl.php, v1.00 2020-05-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<!-- Start edit -->
<h2><?php echo Lang::$word->CF_EDIT;?></h2>
<form method="post" id="wojo_form" name="wojo_form">
  <div class="wojo segment form">
    ...
    <div class="wojo fields">
      <div class="field five wide">
        <label><?php echo Lang::$word->CF_SECTION;?>
          <i class="icon asterisk"></i></label>
        <select name="section">
          <option value="profile" <?php Validator::getSelected($this->data->section, "profile"); ?>><?php echo Lang::$word->CF_SEC_U;?></option>
          <option value="product" <?php Validator::getSelected($this->data->section, "product"); ?>><?php echo Lang::$word->CF_SEC_P;?></option>
        </select>
      </div>
    </div>
    <div class="wojo fields">
...
<?php case "new": ?>
<!-- Start edit -->
<h2><?php echo Lang::$word->CF_NEW;?></h2>
<form method="post" id="wojo_form" name="wojo_form">
  <div class="wojo segment form">
    <div class="wojo fields">
      <div class="field five wide">
    ...
    <div class="wojo fields">
      <div class="field five wide">
        <label><?php echo Lang::$word->CF_SECTION;?>
          <i class="icon asterisk"></i></label>
        <select name="section">
          <option value="profile"><?php echo Lang::$word->CF_SEC_U;?></option>
          <option value="product"><?php echo Lang::$word->CF_SEC_P;?></option>
        </select>
      </div>
    </div>
    <div class="wojo fields">
    ...
    <div class="center aligned">
      <a href="<?php echo Url::url("/admin/fields");?>" class="wojo simple small button"><?php echo Lang::$word->CANCEL;?></a>
      <button type="button" data-action="processField" name="dosubmit" class="wojo secondary button"><?php echo Lang::$word->CF_CREATE;?></button>
    </div>
  </div>
</form>
<?php break;?>
...
<div class="row gutters align middle">
  <div class="columns mobile-100 phone-100">
    <h2><?php echo Lang::$word->META_M_FIELDS;?></h2>
    <p class="wojo small text"><?php echo Lang::$word->CF_INFO;?></p>
  </div>
  <div class="columns auto mobile-100 phone-100">
    <a href="<?php echo Url::url(Router::$path, "new/");?>" class="wojo small secondary button stacked"><i class="icon plus alt"></i><?php echo Lang::$word->CF_NEW;?></a>
  </div>
</div>
<?php if(!$this->data):?>
<div class="center aligned"><img src="<?php echo ADMINVIEW;?>/images/notfound.png" alt="">
  <p class="wojo small thick caps text"><?php echo Lang::$word->CF_EMPTY;?></p>
</div>
<?php else:?>
