<?php
   ...
   * @copyright 2020
   * @version $Id: _memberships_grid.tpl.php, v1.00 2020-04-08 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<div class="row gutters align middle">
  <div class="columns mobile-100 phone-100">
    <h2><?php echo Lang::$word->META_M_MEMBERSHIPS;?></h2>
    <p class="wojo small text"><?php echo Lang::$word->MEM_INFO;?></p>
  </div>
  <div class="columns auto mobile-100 phone-100">
    <a href="<?php echo Url::url(Router::$path, "new/");?>" class="wojo small secondary button stacked"><i class="icon plus alt"></i><?php echo Lang::$word->MEM_NEW;?></a>
  </div>
</div>
<?php if(!$this->data):?>
<div class="center aligned"><img src="<?php echo ADMINVIEW;?>/images/notfound.png" alt="">
  <p class="wojo small thick caps text"><?php echo Lang::$word->MEM_EMPTY;?></p>
</div>
<?php else:?>
