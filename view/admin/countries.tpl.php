...
<form method="post" id="wojo_form" name="wojo_form">
  <div class="wojo segment form">
    ...
    <div class="wojo fields">
      <div class="field five wide">
        <label><?php echo Lang::$word->TAX;?></label>
        <div class="wojo right labeled input">
          <input type="text" placeholder="<?php echo Lang::$word->TAX;?>" value="<?php echo $this->data->vat;?>" name="vat">
...
<?php break;?>
<?php default: ?>
<h2><?php echo Lang::$word->META_M_COUNTRIES;?></h2>
  ...
  <table class="wojo basic responsive table" id="editable">
    <thead>
      <tr>
        ...
        <th data-sort="int"><?php echo Lang::$word->TAX;?></th>
