<?php
   ...
   * @copyright 2020
   * @version $Id: form.tpl.php, v1.00 2020-08-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<?php $url = ($this->gateway->live) ? 'www.payfast.co.za' : 'sandbox.payfast.co.za';?>
  <form action="https://<?php echo $url;?>/eng/process" class="center aligned" method="post" id="pf_form" name="pf_form">
    <input type="image" src="<?php echo SITEURL.'/gateways/payfast/logo_large.png';?>" style="width:200px;margin:1rem auto" class="wojo card" name="submit" title="Pay With PayFast" alt="" onclick="this.form.submit();"/>
	<?php
      $html = '';
      $string = '';
      $array = array(
