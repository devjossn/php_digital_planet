<?php
   ...
   * @copyright 2020
   * @version $Id: form.tpl.php, v1.00 2020-04-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<input type="image" src="<?php echo SITEURL;?>/gateways/paypal/logo_large.png" style="width:200px;margin:1rem auto" name="submit" class="wojo card" title="Pay With Paypal" alt="" onclick="this.form.submit();">
