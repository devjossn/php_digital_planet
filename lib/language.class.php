<?php
   ...
   * @copyright 2017
   * @version $Id: lang.class.php, v 1.00 2017-01-10 21:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
  ...
  final class Lang
  {
      ...
      public function Index()
      {
		  ...
		  $tpl->dir = "admin/";
		  $tpl->crumbs = ['admin', Lang::$word->META_LANGUAGE];
		  $tpl->title = Lang::$word->META_M_LANGUAGE;
      ...
      private static function get()
      {
          ...
          if (isset($_COOKIE['LANG_DDP'])) {
              $sel_lang = Validator::sanitize($_COOKIE['LANG_DDP'], "alpha", 2);
              $vlang = self::fetchLanguage($sel_lang);
              if (in_array($sel_lang . '.lang.xml', $vlang)) {
